...
knitr::include_graphics("TM_B_cells_visual.svg")
```
...
knitr::include_graphics("TM_B_cells_1month.svg")
```
...
```
```{r, echo=FALSE, out.width="700px"}
knitr::include_graphics("TM_B_cells_12months.svg")
```
...
```
```{r, echo=FALSE, out.width="700px"}
knitr::include_graphics("TM_B_cells_24months.svg")
```
...
```
```{r, echo=FALSE, out.width="700px"}
knitr::include_graphics("TM_B_cells_pseudotime.svg")
```
...
```
```{r, echo=FALSE, out.width="700px"}
knitr::include_graphics("TM_B_cells_LinePlot3.svg")
```
