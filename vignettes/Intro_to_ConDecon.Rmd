...
With 'PlotConDecon', we can visualize the relative cell probabilities of each of the 5 bulk sample.
...
knitr::include_graphics("Intro_bulk_CellProb.svg")
```
...
```
```{r, echo=FALSE, out.width="1000px"}
knitr::include_graphics("Intro_bulk_barplot.svg")
```
