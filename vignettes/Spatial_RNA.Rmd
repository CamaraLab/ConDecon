...
```{r, eval=FALSE}
ggplot(stereoseq_meta_data, aes(spatial_x, spatial_y, color = ConDecon_obj$TransferFeatures[1,])) + geom_point() + scale_color_viridis_c(option = "plasma") + theme_linedraw()
```
```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics("Spatial_slice1_TransferFeature.png")
```
...
```
```{r, echo=FALSE, out.width="800px"}
knitr::include_graphics("Spatial_slice1_boxplot.png")
```
